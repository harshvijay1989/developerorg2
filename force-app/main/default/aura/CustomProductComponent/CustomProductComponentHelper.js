({
    getProductInformation : function(component, event, helper) {
        ...
        action.setCallback(this, function(response){
            ...
            if(state === "SUCCESS"){
                ...
                console.log('productWrapper',JSON.stringify(productWrapper));
   ...
   /* getPriceError : function(oliWrapperList) {
    ...
    createOLI : function(component, event, helper) {
        ...
        action.setCallback(this, function(response){
            ...
            if(state === "SUCCESS"){
                ...
                this.toastMessage(component, event, 'Success Message', 'Order has been updated Successfully', 'SUCCESS');
    ...
    createOLIOnSave : function(component, event, helper) {
        debugger;
        component.set('v.displaySpinner',true);
        var action = component.get("c.createOLI");      
        console.log('###@@##'+JSON.stringify(component.get("v.OliWrapperList")))
        ...
        action.setCallback(this, function(response){
            ...
            if(state === "SUCCESS"){
                component.set('v.displaySpinner',false);
                this.toastMessage(component, event, 'Success Message', 'Order has been saved Successfully', 'SUCCESS');
               /* var dismissActionPanel = $A.get("e.force:closeQuickAction");
        		dismissActionPanel.fire();*/
                //commented on Save not to go back on 3rd feb
                /*  var navEvt = $A.get("e.force:navigateToSObject");
    ...
    onTotalChange : function(component, event, helper) {
        ...
        for(var i=0; i<cc.length; i++){
            ...
            if(parseInt(cc[i].quantity) != null){
                ...
                //total += parseFloat(cc[i].NetAmount);
