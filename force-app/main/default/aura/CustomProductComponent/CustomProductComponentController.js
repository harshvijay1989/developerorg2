({
    doInit : function(component, event, helper) {
        ...
        helper.getAccountadd(component, event, helper);
    ...
    handleComponentEvent1 : function(component, event, helper) {
        ...
        var index = event.getSource().get("v.label");//event.target.id;
        //alert(index);
        ...
        if($A.util.isEmpty(selectedProductGetFromEvent)){
            ...
            action.setCallback(this, function(response){
                ...
                if(state === "SUCCESS"){
                    ...
                    console.log('priceBookEntry.UnitPrice',priceBookEntry);
                    ...
                    oliWrapper.StockFlag = priceBookEntry.StockAvailable;
                    oliWrapper.priceBookEntryId = '32783723728372';//priceBookEntry.priceBookEntry.Id;
                    oliWrapper.fileId = priceBookEntry.FileId;
                    component.set("v.OliWrapperList[" + index + "]",oliWrapper);
                    // 09-07-2022 End
    ...
    handleaicmaChange : function(component, event, helper) {
        ...
        console.log(JSON.stringify(oliWrapper));
        component.set("v.OliWrapperList[" + index + "]",oliWrapper);
        console.log('oliWrapperdebugger;debugger;debugger;',oliWrapper)
    ...
    saveOpportunityLineItem: function(component, event, helper) {
     ...
     saveOrderLineItem: function(component, event, helper) {
        ...
        if(errorMessage != ''){
            ...
            helper.createOLIOnSave(component, event, helper);
        }
    },
    ...
    AddSelectedProd: function(component, event, helper) {
        ...
        if(checkvalue == undefined){
            ...
            if(selectedProd == ''){
                ...
                console.log('listOfProducts==>' , component.get('v.listOfProducts'));
                        ...
                        for ( var key in res ) {
                            ...
                            for(var i=0;i<records.length;i++){
                                ...
                                OliWrapperList.push({'productId':records[i].Id , 'product' : records[i],
                                    ...
                                    console.log('records[i].HMC_AICMA__c --> '+records[i]);
                                    ...
                                    OliWrapperList.push({'productId':records[i].Id , 'product' : records[i],'RetaillistPrice' : priceWrapper.RetailUnitPrice ,
                                                         ...
                                                         'listPrice' : priceWrapper.UnitPrice , 'priceBookEntryId' : '0000000000000000',
